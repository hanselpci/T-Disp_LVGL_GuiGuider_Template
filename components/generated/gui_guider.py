...
screen_cont_1.set_size(135,240)
screen_label_1 = lv.label(screen_cont_1)
screen_label_1.set_pos(1,100)
screen_label_1.set_size(133,39)
screen_label_1.set_text("Hello world!")
...
try:
    style_screen_label_1_main_main_default.set_text_font(lv.font_montserratMedium_14)
...
style_screen_cont_1_main_main_default.set_border_color(lv.color_make(0xff,0x00,0x00))
style_screen_cont_1_main_main_default.set_border_width(1)
