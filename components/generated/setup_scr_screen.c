...
void setup_scr_screen(lv_ui *ui){
	...
	lv_obj_set_size(ui->screen_cont_1, 135, 240);
	...
	lv_obj_set_pos(ui->screen_label_1, 1, 100);
	lv_obj_set_size(ui->screen_label_1, 133, 39);
	...
	lv_style_set_text_font(&style_screen_label_1_main_main_default, &lv_font_montserratMedium_14);
